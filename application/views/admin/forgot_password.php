...
<head>
  ...
  <title>AdminBGS | Forgot Password</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('admin');?>"><b>Admin</b>BGS</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <!--
      <p class="mb-0">
        <a href="<?php echo base_url('Admin_login/register'); ?>" class="text-center">Register a new membership</a>
      </p>
      -->
