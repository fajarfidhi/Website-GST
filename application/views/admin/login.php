            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <br>
                  <form method="POST" action="<?= base_url('Login_Admin/cekdata'); ?>" id="formLogin" class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="txtemail" id="txtemail" value="<?= set_value('txtemail') ?>" placeholder="Enter Email Address...">
                      <?= form_error('txtemail', '<small class="text-danger">', '</small>') ?>
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="txtpassword" name="txtpassword" value="<?= set_value('txtpassword') ?>" placeholder="Password">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?= base_url('AdminLogin/forgot') ?>">Forgot Password?</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="<?= base_url('CreateUser') ?>">Create an Account!</a>
                  </div>
                  </>
                </div>
              </div>
